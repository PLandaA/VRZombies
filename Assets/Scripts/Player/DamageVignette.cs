...
namespace VRZ.Player
{
    ...
    public class DamageVignette : MonoBehaviour
    {
        ...
        private IPlayerState _localPlayer;
        ...
        private void Update()
        {
            ...
            if (_localPlayer == null)
            {
                ...
                if (session != null && session.IsRunning)
                    _localPlayer = session.GetPlayer();
                if (_localPlayer == null) return;
            }
            if (!_localPlayer.IsValid || _image == null) return;
            ...
            float baseAlpha = 0f;
            if (_localPlayer.IsAlive && health01 <= lowHealthThreshold && health01 > 0f)
            {
